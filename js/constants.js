...
const ALL_ROLES = [ROLES.MASTER, ROLES.TEAM_MANAGER, ROLES.PROFESSOR, ROLES.STAFF, ROLES.VIEWER];
const EDIT_ROLES = [ROLES.MASTER, ROLES.TEAM_MANAGER, ROLES.STAFF];
const COMMENT_ROLES = [ROLES.MASTER, ROLES.TEAM_MANAGER, ROLES.PROFESSOR];
